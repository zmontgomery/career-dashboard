INSERT INTO student_details(id, university_id, gpa, description, graduation_year, start_year, year_level) 
VALUES (UUID_TO_BIN(UUID()), 'jrl9984@g.rit.edu', 3.900, 'James', "Jim", "Logan", 1, 1),
